export const SHEET_CSV_URL = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vSfLdTarK1vrpJrAyQKZS2osVJQf7W2s550tJeOvcWMzYQGtRmU-yrJgKNyCjdsDAl-9ODWQ7uk_LwC/pub?gid=0&single=true&output=csv';
  

export const WHATSAPP_NUMBER = '2348109226360';
export const WHATSAPP_URL = (msg) => `https://wa.me/2348109226360?text=${encodeURIComponent(msg)}`;
