...
export default function WhatsAppButton() {
  return (
    <a href={WHATSAPP_URL} target="_blank" rel="noopener noreferrer" className="wa-float-btn" aria-label="Order on WhatsApp">
      ...
      <span className="wa-float-btn__tooltip">Order on WhatsApp</span>
    </a>
  );
}